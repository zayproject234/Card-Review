(function () {
  ...
  var DEFAULT_CARDS = [
    ...
    // BAB 4
    [4, '今 〜時 〜分です', '今 4時 5分です。', '1. Menyebutkan Jam dan Menit', 'ima yo-ji go-fun desu.', 'Sekarang jam 4 lewat 5 menit.'],
    [4, '[Kata Kerja]-masu / [Kata Kerja]-masen', '毎朝 6時に 起きます。 / 起きません。', '2. KK Bentuk Non-Lampau (Rutin/Masa Depan)', 'okimasu / okimasen.', 'Bangun / Tidak bangun (rutin/masa depan).'],
    [4, '[Kata Kerja]-mashita / [Kata Kerja]-masen deshita', 'きのう 勉強しました。 / 勉強しませんでした。', '3. KK Bentuk Lampau (Sudah/Belum terjadi)', 'benkyou shimashita / benkyou shimasen deshita.', 'Kemarin belajar. / Kemarin tidak belajar.'],
    [4, '[Waktu Spesifik] に [Kata Kerja]', '6時に 起きます。', '4. Partikel に untuk penunjuk waktu spesifik', 'roku-ji ni okimasu.', 'Bangun jam 6.'],
    [4, '[Waktu 1] kara [Waktu 2] made', '9時から 5時まで 働きます。', '5. Dari (kara) sampai (made)', 'ku-ji kara go-ji made hatarakimasu.', 'Bekerja dari jam 9 sampai jam 5.'],
    [4, '[Kata Benda 1] と [Kata Benda 2]', '土曜日と 日曜日', '6. Partikel と (Dan - Menghubungkan KB)', 'doyoubi to nichiyoubi.', 'Sabtu dan Minggu.'],
    [4, '[Kalimat] ね', '大変ですね。', '7. Partikel ね (Kan / Ya - Meminta persetujuan)', 'taihen desu ne.', 'Susah ya / Berat ya (mencari persetujuan).'],

    // BAB 5
    [5, '[Tempat] へ 行きます／来ます／帰ります', '京都へ 行きます。', '1. Arah pergerakan (Pergi/Datang/Pulang ke tempat)', 'Kyouto e ikimasu.', 'Saya pergi ke Kyoto.'],
    [5, 'どこ [へ] も 行きません／行きませんでした', 'どこも 行きませんでした。', '2. Negatif total (Tidak pergi ke mana pun)', 'doko mo ikimasen deshita.', 'Kemarin tidak pergi ke mana pun.'],
    [5, '[Kendaraan] で 行きます', '電車で 行きます。', '3. Alat transportasi (Pergi naik/menggunakan)', 'densha de ikimasu.', 'Saya pergi naik kereta.'],
    [5, '歩いて 行きます／帰ります', '駅から 歩いて 帰ります。', '4. Berjalan kaki (Tanpa partikel de)', 'eki kara aruite kaerimasu.', 'Pulang dari stasiun dengan berjalan kaki.'],
    [5, '[Orang] と [Kata Kerja]', '友達と 日本へ 来ました。', '5. Bersama dengan (orang/hewan)', 'tomodachi to Nihon e kimashita.', 'Saya datang ke Jepang bersama teman.'],
    [5, 'いつ [Kata Kerja] か', 'いつ 日本へ 来ましたか。', '6. Menanyakan waktu (Kapan - tanpa partikel ni)', 'itsu Nihon e kimashita ka.', 'Kapan Anda datang ke Jepang?'],
    [5, '[Kalimat] よ', 'この 電車は 甲子園へ 行きますよ。', '7. Partikel よ (Memberi tahu informasi baru/lho)', 'kono densha wa Koushien e ikimasu yo.', 'Kereta ini menuju Koushien lho.'],

    // BAB 6
    [6, '[Kata Benda] を [Kata Kerja]', 'パンを 食べます。', '1. Objek kata kerja (Partikel を / o)', 'pan o tabemasu.', 'Saya makan roti.'],
    [6, '[Kata Benda] を します', 'サッカーを します。 / 宿題を します。', '2. Melakukan kegiatan/olahraga/pekerjaan', 'sakkaa o shimasu / shukudai o shimasu.', 'Bermain sepak bola. / Mengerjakan PR.'],
    [6, '何を しますか', '月曜日 何を しますか。', '3. Menanyakan aktivitas (Melakukan apa?)', 'getsuyoubi nani o shimasu ka.', 'Hari Senin akan melakukan apa?'],
    [6, '[Tempat] で [Kata Kerja]', 'レストランで ごはんを 食べます。', '4. Tempat berlangsungnya aktivitas (Partikel で)', 'resutoran de gohan o tabemasu.', 'Saya makan nasi di restoran.'],
    [6, '[Kata Kerja]-masen ka', 'いっしょに 行きませんか。', '5. Ajakan halus: "Mau kah...?" / "Bagaimana kalau...?"', 'issho ni ikimasen ka.', 'Maukah pergi bersama?'],
    [6, '[Kata Kerja]-mashou', 'ちょっと 休みましょう。', '6. Ajakan tegas / respon ajakan: "Mari kita..."', 'chotto yasumimashou.', 'Mari kita istirahat sebentar.'],

    // BAB 7
    [7, '[Alat / Bahasa] で [Kata Kerja]', 'はしで 食べます。 / 日本語で 話します。', '1. Menggunakan alat / sarana / bahasa (Partikel で)', 'hashi de tabemasu. / nihongo de hanashimasu.', 'Makan menggunakan sumpit. / Berbicara dalam bahasa Jepang.'],
    [7, '「[Kata]」は [Bahasa] で 何ですか', '「Arigatou」は 英語で 何ですか。', '2. Menanyakan padanan kata dalam bahasa lain', '"Arigatou" wa Eigo de nan desu ka.', '"Arigatou" dalam bahasa Inggris apa?'],
    [7, '[Orang] に [Kata Benda] を あげます', '木村さんに 花を あげました。', '3. Memberikan barang kepada seseorang (ni agemasu)', 'Kimura-san ni hana o agemashita.', 'Saya memberikan bunga kepada Sdr. Kimura.'],
    [7, '[Orang] に／から [Kata Benda] を もらいます', '山田さんに 本を もらいました。', '4. Menerima barang dari seseorang (ni/kara moraimasu)', 'Yamada-san ni hon o moraimashita.', 'Saya menerima buku dari Sdr. Yamada.'],
    [7, 'もう [Kata Kerja]-mashita', 'もう 昼ごはんを 食べました。', '5. Sudah melakukan kegiatan (mou + bentuk lampau)', 'mou hirugohan o tabemashita.', 'Saya sudah makan siang.'],
    [7, 'いいえ、まだです', '「もう 送りましたか。」「いいえ、まだです。」', '6. Belum melakukan (Respon untuk pertanyaan mou)', '"mou okurimashita ka." "iie, mada desu."', '"Sudah dikirim?" "Belum."'],

    // BAB 8
    [8, '[Kata Benda] は [KS-i] です／〜くないです', '富士山は 高いです。 / 面白くないです。', '1. Predikat Kata Sifat-i (Positif & Negatif)', 'Fujisan wa takai desu. / omoshirokunai desu.', 'Gunung Fuji tinggi. / Tidak menarik.'],
    [8, '[Kata Benda] は [KS-na] です／〜じゃ ありません', 'ワット先生は 親切です。 / 静かじゃ ありません。', '2. Predikat Kata Sifat-na (Positif & Negatif)', 'Watto-sensei wa shinsetsu desu. / shizuka ja arimasen.', 'Pak Watt ramah. / Tidak tenang.'],
    [8, '[KS-i] [KB] / [KS-na] な [KB]', '高い 山 / きれいな 部屋', '3. Kata Sifat menerangkan Kata Benda', 'takai yama / kirei na heya', 'Gunung yang tinggi. / Kamar yang bersih.'],
    [8, 'とても [+] / あまり [-]', 'とても 寒いです。 / あまり 寒くないです。', '4. Tingkat derajat (Sangat / Tidak begitu)', 'totemo samui desu. / amari samukunai desu.', 'Sangat dingin. / Tidak begitu dingin.'],
    [8, '[Kata Benda] は どうですか', '日本の 生活は どうですか。', '5. Menanyakan kesan / kondisi (Bagaimana...?)', 'Nihon no seikatsu wa dou desu ka.', 'Bagaimana kehidupan di Jepang?'],
    [8, '[KB 1] は どんな [KB 2] ですか', '奈良は どんな 町ですか。', '6. Menanyakan ciri/sifat (Benda yang bagaimana?)', 'Nara wa donna machi desu ka.', 'Nara adalah kota yang bagaimana?'],
    [8, '[Kalimat 1] が、[Kalimat 2]', '日本の 食べ物は 美味しいですが、高いです。', '7. Pertentangan (Tetapi / Namun)', 'Nihon no tabemono wa oishii desu ga, takai desu.', 'Makanan Jepang enak, tetapi mahal.'],

    // BAB 9
    [9, '[KB] が すき／きらい／じょうず／へた です', 'わたしは イタリア料理が 好きです。', '1. Suka / Benci / Pandai / Mahir (Partikel が)', 'watashi wa Itaria ryouri ga suki desu.', 'Saya suka masakan Italia.'],
    [9, '[KB] が あります／わかります', '日本語が わかります。 / 車が あります。', '2. Memiliki / Mengerti (Partikel が)', 'nihongo ga wakarimasu. / kuruma ga arimasu.', 'Saya mengerti bahasa Jepang. / Saya punya mobil.'],
    [9, 'よく／だいたい／すこし／あまり／ぜんぜん', '英語が よく わかります。 / ぜんぜん わかりません。', '3. Tingkat pemahaman / kuantitas', 'Eigo ga yoku wakarimasu. / zenzen wakarimasen.', 'Sangat paham bahasa Inggris. / Sama sekali tidak paham.'],
    [9, '[Alasan] から、[Kalimat]', '時間が ありませんから、タクシーで 行きます。', '4. Menyatakan alasan (Karena..., maka...)', 'jikan ga arimasen kara, takushii de ikimasu.', 'Karena tidak ada waktu, saya naik taksi.'],
    [9, 'どうして [Kalimat] か', 'どうして 朝新聞を 読みませんか。', '5. Menanyakan alasan (Mengapa / Kenapa?)', 'doushite asa shinbun o yomimasen ka.', 'Mengapa tidak membaca koran pagi?'],
    [9, '[Alasan] から', '「どうして 帰りますか。」「用事が ありますから。」', '6. Menjawab pertanyaan alasan (Karena...)', '"doushite kaerimasu ka." "youji ga arimasu kara."', '"Mengapa pulang?" "Karena ada keperluan."'],

    // BAB 10
    [10, '[Tempat] に [KB Mati] が あります', '部屋に 机が あります。', '1. Keberadaan benda mati / tanaman (arimasu)', 'heya ni tsukue ga arimasu.', 'Di kamar ada meja.'],
    [10, '[Tempat] に [KB Hidup] が います', '庭に 犬が います。', '2. Keberadaan manusia / hewan (imasu)', 'niwa ni inu ga imasu.', 'Di halaman ada anjing.'],
    [10, '[Tempat] に 何が ありますか／だれが いますか', '事務所に だれが いますか。', '3. Menanyakan keberadaan (Ada apa / siapa?)', 'jimusho ni dare ga imasu ka.', 'Di kantor ada siapa?'],
    [10, '[KB] は [Tempat] に あります／います', '東京ディズニーランドは 千葉県に あります。', '4. Lokasi benda/orang spesifik (KB ada di...)', 'Toukyou Dizuniirando wa Chiba-ken ni arimasu.', 'Tokyo Disneyland ada di Prefektur Chiba.'],
    [10, '[KB 1] の [Posisi] に [KB 2] が あります／います', '机の 上に 写真が あります。', '5. Penunjuk posisi relatif (ue/shita/mae/ushiro/naka/tonari)', 'tsukue no ue ni shashin ga arimasu.', 'Di atas meja ada foto.'],
    [10, '[KB 1] と [KB 2] の 間 に [KB 3] が あります／います', '本屋と 銀行の 間に あります。', '6. Lokasi di antara dua benda (aida)', 'hon\'ya to ginkou no aida ni arimasu.', 'Ada di antara toko buku dan bank.'],
    [10, '[KB 1] や [KB 2] など', '箱の 中に 手紙や 写真などが あります。', '7. Menyebutkan beberapa contoh benda (dan lain-lain)', 'hako no naka ni tegami ya shashin nado ga arimasu.', 'Di dalam kotak ada surat, foto, dan lain-lain.'],

    // BAB 11
    [11, '[KB] を [Bilangan/Satuan] [Kata Kerja]', 'りんごを 4つ 買いました。', '1. Posisi bilangan/jumlah sebelum KK', 'ringo o yottsu kaimashita.', 'Membeli 4 buah apel.'],
    [11, '[Jumlah Orang] で [Kata Kerja]', '5人で 行きます。 / 1人で 行きます。', '2. Jumlah orang yang melakukan kegiatan', 'go-nin de ikimasu. / hitori de ikimasu.', 'Pergi berlima. / Pergi sendiri.'],
    [11, '[Periode Waktu] に [Frekuensi] [KK]', '1か月に 2回 映画を 見ます。', '3. Frekuensi dalam periode waktu', 'ikkagetsu ni ni-kai eiga o mimasu.', 'Dalam 1 bulan menonton film 2 kali.'],
    [11, '[KB / Jumlah] だけ', '休みは 日曜日だけです。', '4. Keterangan "Hanya / Saja" (dake)', 'yasumi wa nichiyoubi dake desu.', 'Hari libur hanya hari Minggu saja.'],
    [11, '[Lama Waktu] かかります', 'うちから 会社まで 1時間半 かかります。', '5. Memakan waktu / durasi (kakarimasu)', 'uchi kara kaisha made ichi-jikan-han kakarimasu.', 'Dari rumah ke kantor memakan waktu 1,5 jam.'],
    [11, 'どの くらい [Kata Kerja] か', 'どのくらい 日本語を 勉強しましたか。', '6. Menanyakan durasi/lama waktu (dono kurai)', 'dono kurai nihongo o benkyou shimashita ka.', 'Sudah belajar bahasa Jepang berapa lama?'],

    // BAB 12
    [12, '[KB / KS-na] でした／じゃ ありませんでした', 'きのうは 雨でした。 / 静かじゃ ありませんでした。', '1. Lampau KB & KS-na (deshita / ja arimasen deshita)', 'kinou wa ame deshita. / shizuka ja arimasen deshita.', 'Kemarin hujan. / Tidak tenang (kemarin).'],
    [12, '[KS-i] 〜かったです／〜くなかったです', 'きのうは 暑かったです。 / 寒くなかったです。', '2. Lampau KS-i (~katta desu / ~kunakatta desu)', 'kinou wa atsukatta desu. / samukunakatta desu.', 'Kemarin panas. / Tidak dingin (kemarin).'],
    [12, '[KB 1] は [KB 2] より [KS] です', '日本は 台湾より 広いです。', '3. Perbandingan dua benda (KB1 lebih... daripada KB2)', 'Nihon wa Taiwan yori hiroi desu.', 'Jepang lebih luas daripada Taiwan.'],
    [12, '[KB 1] と [KB 2] と どちらが [KS] ですか', 'サッカーと 野球と どちらが 面白いですか。', '4. Menanyakan perbandingan 2 benda (Mana yang lebih...?)', 'sakkaa to yakyuu to dochira ga omoshiroi desu ka.', 'Antara sepak bola dan bisbol, mana yang lebih menarik?'],
    [12, '[Kategori] で [Kata Tanya] が 一番 [KS] ですか', '日本で どこが 一番 きれいですか。', '5. Superlatif / Paling... dalam kategori (ichiban)', 'Nihon de doko ga ichiban kirei desu ka.', 'Di Jepang, tempat mana yang paling indah?'],

    // BAB 13
    [13, '[Kata Benda] が ほしいです', '車が ほしいです。', '1. Ingin memiliki benda (hoshii desu)', 'kuruma ga hoshii desu.', 'Saya ingin punya mobil.'],
    [13, '[Kata Kerja-stem] たいです', '沖縄へ 行きたいです。', '2. Ingin melakukan kegiatan (KK-stem + tai desu)', 'Okinawa e ikitai desu.', 'Saya ingin pergi ke Okinawa.'],
    [13, '[KK-stem] たくないです／たかったです', '何も 食べたくないです。', '3. Negatif / Lampau bentuk keinginan (~tai)', 'nani mo tabetakunai desu.', 'Tidak ingin makan apa pun.'],
    [13, '[Tempat] へ [KK-stem / KB] に 行きます', 'デパートへ 買い物に 行きます。', '4. Pergi/datang/pulang untuk suatu tujuan (ni ikimasu)', 'depaato e kaimono ni ikimasu.', 'Saya pergi ke department store untuk berbelanja.'],
    [13, '何が ほしいですか／何を したいですか', '誕生日に 何が ほしいですか。', '5. Menanyakan keinginan benda/kegiatan', 'tanjoubi ni nani ga hoshii desu ka.', 'Di hari ulang tahun, ingin (hadiah) apa?'],

    // BAB 14
    [14, '[Kata Kerja-te] ください', 'ちょっと 待ってください。', '1. Permintaan halus (Tolong lakukan...)', 'chotto matte kudasai.', 'Tolong tunggu sebentar.'],
    [14, '[Kata Kerja-te] います', '今 雨が 降っています。', '2. Sedang melakukan kegiatan (Sedang...)', 'ima ame ga futte imasu.', 'Sekarang hujan sedang turun.'],
    [14, '[Kata Kerja-stem] ましょうか', '傘を 貸しましょうか。', '3. Menawarkan bantuan (Bagaimana kalau saya...?)', 'kasa o kashimashou ka.', 'Bagaimana kalau saya pinjamkan payung?'],
    [14, '[Kata Benda] が [KK-te] います', 'タクシーが 止まっています。', '4. Keadaan/kejadian yang sedang berlangsung', 'takushii ga tomatte imasu.', 'Taksi sedang berhenti.'],
    [14, '[Kalimat 1] が、[Kalimat 2]', '失礼ですが、お名前は？', '5. Awalan halus sebelum meminta/bertanya (ga)', 'shitsurei desu ga, o-namae wa?', 'Maaf mengganggu, nama Anda siapa?'],

    // BAB 15
    [15, '[Kata Kerja-te] も いいですか', '写真を 撮っても いいですか。', '1. Meminta izin (Bolehkah...?)', 'shashin o tottemo ii desu ka.', 'Bolehkah mengambil foto?'],
    [15, '[Kata Kerja-te] は いけません', 'ここで たばこを 吸っては いけません。', '2. Larangan (Dilarang / tidak boleh...)', 'koko de tabako o suttewa ikemasen.', 'Dilarang merokok di sini.'],
    [15, '[Kata Kerja-te] います (Status)', 'わたしは 結婚して います。 / 大阪に 住んで います。', '3. Status mapan/hasil aksi (Menikah/Tinggal di...)', 'watashi wa kekkon shite imasu. / Osaka ni sunde imasu.', 'Saya sudah menikah. / Tinggal di Osaka.'],
    [15, '[Kata Kerja-te] います (Pekerjaan/Aset)', 'IMCで 働いて います。 / 車を 持って います。', '4. Pekerjaan tetap / Kepemilikan benda (Bekerja di/Mempunyai)', 'IMC de hataraite imasu. / kuruma o motte imasu.', 'Bekerja di IMC. / Mempunyai mobil.'],
    [15, 'お仕事は 何を して いますか', '「お仕事は 何を して いますか。」「先生です。」', '5. Menanyakan pekerjaan / profesi seseorang', '"o-shigoto wa nani o shite imasu ka." "sensei desu."', '"Pekerjaannya apa?" "Saya guru."'],

    // BAB 16
    [16, '[KK1-te], [KK2-te], [KK3]', '食べて、読んで、行きます。', '1. Urutan kegiatan berurutan (KK-te, KK-te, KK)', 'tabete, yonde, ikimasu.', 'Makan, membaca, lalu pergi.'],
    [16, '[KK 1-te] から、[KK 2]', '仕事が 終わってから、泳ぎます。', '2. Setelah melakukan suatu aksi (te kara)', 'shigoto ga owatte kara, oyogimasu.', 'Setelah pekerjaan selesai, baru berenang.'],
    [16, '[KS-i]-kute / [KS-na / KB] de', '東京は 広くて、賑やかです。', '3. Menghubungkan sifat/kata benda (dan...)', 'Toukyou wa hirokute, nigiyaka desu.', 'Tokyo luas dan ramai.'],
    [16, '[KB 1] は [KB 2 (Bagian Tubuh)] が [KS]', 'マリアさんは 髪が 長いです。', '4. Menerangkan ciri fisik/bagian tubuh', 'Maria-san wa kami ga nagai desu.', 'Maria rambutnya panjang.'],
    [16, '[Tempat] kara [KB] o oroshimasu', '銀行から お金を おろします。', '5. Mengambil/mengeluarkan barang dari tempat', 'ginkou kara o-kane o oroshimasu.', 'Mengambil uang dari bank.'],
    [16, '[Tempat] を 降ります／出ます', '7時に 部屋を 出ます。 / 電車を 降ります。', '6. Keluar / turun dari tempat/kendaraan (o orimasu/demasu)', 'shichi-ji ni heya o demasu. / densha o orimasu.', 'Keluar kamar jam 7. / Turun dari kereta.'],
    [16, 'どうやって [Kata Kerja]', '郵便局まで どうやって 行きますか。', '7. Menanyakan cara / rute / petunjuk jalan (douyatte)', 'yuubinkyoku made douyatte ikimasu ka.', 'Bagaimana cara pergi ke kantor pos?'],
    [16, 'どれ / どの [Kata Benda]', 'ミラーさんの 傘は どれですか。 / どの 傘ですか。', '8. Memilih 1 dari 3+ pilihan (dore / dono + KB)', 'Miraa-san no kasa wa dore desu ka.', 'Payung Sdr. Miller yang mana?'],
